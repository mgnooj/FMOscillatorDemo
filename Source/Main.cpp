...
public:
    ...
    const juce::String getApplicationName() override       { return "FMOscillatorDemo"; }
    const juce::String getApplicationVersion() override    { return "1.0.0"; }

    void initialise (const juce::String&) override
    {
        mainWindow.reset (new MainWindow ("FMOscillatorDemo", std::make_unique<AudioSynthesiserDemo>(), *this));
    }
